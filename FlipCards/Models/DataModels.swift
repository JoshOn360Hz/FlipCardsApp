...
class Card {
    ...
    var frontDrawingData: Data?
    var backDrawingData: Data?
    
    init(frontText: String, backText: String, difficulty: Difficulty = .medium, glyph: DeckGlyph = .lightbulb, deck: Deck? = nil, cardType: CardType = .flashcard) {
        self.id = UUID()
